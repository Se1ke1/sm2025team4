...
<%--상품 등록 페이지 - 신창영--%>
<%-- css/product-registration.css에 css파일 추가하였음 --%>
        ...
        <div class="product-form">
          <form>
            ...
            <div class="form-section">
              <label>상품이미지</label>
              <input type="file" accept="imags/*" multiple>
              <div class="image-box">
                <span>이미지 등록</span>
              </div>
            ...
            <div class="form-section">
              <label>상품 소개란</label>
              <textarea type="text" placeholder="상품 내용을 적어주세요." class="form-control" rows="5" id="comment"></textarea>
            </div>
